...
const Footer = () => {
  return (
    <div className='max-w-[1380px] bg-black mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-white'>
      <div>
        <h1 className='w-full text-3xl font-bold text-white'>Aman Bussiness</h1>
